...
public class LeatherBackpackGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public LeatherBackpackGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(RpgBackpacksModMenus.LEATHER_BACKPACK_GUI.get(), id);
	...
	public void removed(Player playerIn) {
		...
		ReverseLeatherBackpackGUIThisGUIIsClosedProcedure.execute(world, entity);
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof LeatherBackpackGUIMenu) {
			Level world = entity.level();
			double x = entity.getX();
			double y = entity.getY();
			double z = entity.getZ();
			LeatherBackpackGUIThisGUIIsOpenedProcedure.execute(world, entity);
		}
	}
}
