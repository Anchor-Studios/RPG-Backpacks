...
import net.rpgbackpacks.procedures.ReverseIBGUIThiGUIIsClosedProcedure;
import net.rpgbackpacks.procedures.PlayerJoinsProcedure;
import net.rpgbackpacks.procedures.IBGUIIsOpenedProcedure;
...
public class IronBackpackGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public IronBackpackGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(RpgBackpacksModMenus.IRON_BACKPACK_GUI.get(), id);
	...
	public void removed(Player playerIn) {
		...
		ReverseIBGUIThiGUIIsClosedProcedure.execute(world, entity);
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof IronBackpackGUIMenu) {
