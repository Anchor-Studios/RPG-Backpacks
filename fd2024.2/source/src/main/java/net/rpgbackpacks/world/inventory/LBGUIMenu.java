...
public class LBGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public LBGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(RpgBackpacksModMenus.LBGUI.get(), id);
