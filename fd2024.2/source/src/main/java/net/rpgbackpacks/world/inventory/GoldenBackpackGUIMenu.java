...
public class GoldenBackpackGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public GoldenBackpackGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(RpgBackpacksModMenus.GOLDEN_BACKPACK_GUI.get(), id);
	...
	public void removed(Player playerIn) {
		...
		ReverseGBGuIIsClosedProcedure.execute(world, entity);
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof GoldenBackpackGUIMenu) {
			Level world = entity.level();
			double x = entity.getX();
			double y = entity.getY();
			double z = entity.getZ();
			GBGUIIsOpenedProcedure.execute(world, entity);
		}
	}
}
