...
public class RpgBackpacksModTabs {
	...
	public static final RegistryObject<CreativeModeTab> RPG_BACKPACKS = REGISTRY.register("rpg_backpacks",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.rpg_backpacks.rpg_backpacks")).icon(() -> new ItemStack(RpgBackpacksModItems.LEATHER_BACKPACK.get())).displayItems((parameters, tabData) -> {
