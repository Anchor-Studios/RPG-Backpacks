...
public class GoldenBackpackInventoryCapability implements ICapabilitySerializable<CompoundTag> {
	@SubscribeEvent
	@OnlyIn(Dist.CLIENT)
	...
	private ItemStackHandler createItemHandler() {
		return new ItemStackHandler(45) {
			...
			public boolean isItemValid(int slot, @Nonnull ItemStack stack) {
				return stack.getItem() != RpgBackpacksModItems.GOLDEN_BACKPACK.get();
			}
