...
import net.rpgbackpacks.item.inventory.IronBackpackInventoryCapability;
...
public class IronBackpackItem extends Item implements ICurioItem {
	public IronBackpackItem() {
	...
	public ICapabilityProvider initCapabilities(ItemStack stack, @Nullable CompoundTag compound) {
		return new IronBackpackInventoryCapability();
	}
