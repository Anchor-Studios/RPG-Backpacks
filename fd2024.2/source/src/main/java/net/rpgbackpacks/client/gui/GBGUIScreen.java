...
public class GBGUIScreen extends AbstractContainerScreen<GBGUIMenu> {
	private final static HashMap<String, Object> guistate = GBGUIMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public GBGUIScreen(GBGUIMenu container, Inventory inventory, Component text) {
