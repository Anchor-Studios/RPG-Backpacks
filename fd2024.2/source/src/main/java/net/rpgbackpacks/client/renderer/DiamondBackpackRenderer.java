package net.rpgbackpacks.client.renderer;

import top.theillusivec4.curios.api.client.ICurioRenderer;
import top.theillusivec4.curios.api.SlotContext;

import net.rpgbackpacks.init.RpgBackpacksModLayerDefinitions;
...
public class DiamondBackpackRenderer implements ICurioRenderer {
	...
	public DiamondBackpackRenderer() {
		this.model = new Modelbackpack(Minecraft.getInstance().getEntityModels().bakeLayer(RpgBackpacksModLayerDefinitions.DIAMOND_BACKPACK));
	}
