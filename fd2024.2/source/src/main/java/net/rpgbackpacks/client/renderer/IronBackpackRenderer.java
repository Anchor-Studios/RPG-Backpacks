...
public class IronBackpackRenderer implements ICurioRenderer {
	...
	public IronBackpackRenderer() {
		this.model = new Modelbackpack(Minecraft.getInstance().getEntityModels().bakeLayer(RpgBackpacksModLayerDefinitions.IRON_BACKPACK));
	}
